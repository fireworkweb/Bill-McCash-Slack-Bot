export default {
    ...
    msg: {
        ...
        wait: 'Just a second <@{user}>, I\'ll get in touch with some people and get you the exchange rate. :bar_chart:',
        boss: 'Hey there, boss <@{user}>! Eager to get your hands on some dollars, eh? Alright, the exchange rate is this. One day I will be as rich as you are!',
